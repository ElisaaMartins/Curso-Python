# Uma função que chama ela mesma dentro dela, várias vezes

# Fórmula geral para o fatorial:
# fatorial(num) = 1, se num 0 ou se num1 'Caso-Base'
# fatorial (num) = num * fatorial(num1), para num -> 1 'Caso Recursivo 
